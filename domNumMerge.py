...
sequences = []
seq_length = []
with open("/Users/Graceyh/Google Drive/AboutDissertation/Data/pdb_seqres.txt", "rU") as handle:
...
with open("/Users/Graceyh/Google Drive/AboutDissertation/Data/cullpdb_pc90_res3.0_R1.0_d160629_chains32284") as abPDB:
    next(abPDB)
    for line in abPDB:
        columns = line.split()
...
# data_all = pd.concat([df_pdb,df_CATHDomall],axis=1,join='inner').drop_duplicates()
...
data_all.to_csv('/Users/Graceyh/Desktop/ProteinDataAll_correct.csv',index = False)
